 ...
 */
void ABelicaCharacter::BeginPlay() { Super::BeginPlay(); }
...
void ABelicaCharacter::Tick( float DeltaTime ) {
	...
	if ( WeaponHandling ) { WeaponHandling->ChangeCameraFOV(DeltaTime); }
}
...
void ABelicaCharacter::StartAiming() { WeaponHandling->SetIsAiming(true); }

void ABelicaCharacter::StopAiming() { WeaponHandling->SetIsAiming(false); }
...
void ABelicaCharacter::EndWeaponFIre() { WeaponHandling->SetShouldFireWeapon(true); }

void ABelicaCharacter::ToggleRun() { GetCharacterMovement()->MaxWalkSpeed = 900.0f; }

void ABelicaCharacter::ToggleWalk() { GetCharacterMovement()->MaxWalkSpeed = 300.0f; }
